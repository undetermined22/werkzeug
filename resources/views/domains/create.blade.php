                    ...
                    <form action="{{ route('domains.store') }}" method="POST">
                        <div class="overflow-hidden sm:rounded-md">
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="mb-10">
                                    <h3 class="text-lg font-medium leading-6 text-gray-900">Add a new domain</h3>
                                    @csrf
                                </div>
                                @if ($errors->any())
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="date" name="expiration_date" value="{{ old('expiration_date') }}" id="expiration_date" required class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
